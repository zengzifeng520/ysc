...
var rule = {
	...
	//host: 'http://gvvwvvvvwwwvvvvvvwvwwvwvwvwvwvwvwvwvwvwwvwvwvwvwvwvwvwvvwvwvwvv.lfytyl.com/api.php/app/',
	//host: 'https://ttkx.obs.cn-east-3.myhuaweicloud.com/0.json',
  ...
  hostJs:'print(HOST);let html=request(HOST,{headers:{"User-Agent":"Dart/3.0 (dart:io)"}});let src = JSON.parse(html).domain;print(src);HOST=src',
	...
	timeout:5000,
	class_name:'新电影4K&新剧4K&好莱坞4K&港台经典4k&少儿动画4K&合拍经典4K&邵氏老电影4K&明星专辑4K&六公主4K&豆瓣Top250电影4K&豆瓣Top100影视剧4K&电影综合&电视剧综合&动漫&综艺&体育赛事', // 分类筛选 /api.php/app/nav
	class_url:'20&21&47&48&50&51&5&45&44&49&46&1&2&4&3&32',
	play_parse:true,
		lazy:'js:if(/m3u8|mp4/.test(input)){input}else if(/XY/.test(input)){let purl=request("http://mao.lyyytv.cn/json.php?url=?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
	limit:6,
	推荐:'json:list;vlist;*;*;*;*',
	double: true,
